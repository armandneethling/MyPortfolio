document.addEventListener("DOMContentLoaded", function () {
    ...
    // Add intersection observer fopr animations
    ...
    if (terminalContainer && terminalContent && commandSpan) {
        const commandText = "git clone https://github.com/armandneethling/MyPortfolio.git";
        ...
        const typeCommand = () => {
            if (i < commandText.length) {
                ...
                cursor.className = 'inline-block w-2 h-5 bg-gray-900 dark:bg-white ml-1 align-middle';
        ...
        if (terminal) {
            ...
            const typeCommand = () => {
                if (i < commandText.length) {
                    ...
                    cursor.style.animation = 'blink 1s step-end infinite';
                    terminal.querySelector('.command').insertAdjacentElement('afterend', cursor);
                }
            };
